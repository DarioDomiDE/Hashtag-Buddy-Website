...
{el.css("background-color","#000000");el.css("background-image","url('./data/spinner-white.gif')");el.css("background-size","auto");el.attr('data-content-cover-bg','');var loop=!1;var muted=!0;if(noloop!=''){loop=!1}else{loop=!0}
